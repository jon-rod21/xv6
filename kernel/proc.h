 ...
 * ptable needs to be accesed in other files as well, not just proc.c
 * changing the decleration so its public using 'extern'
 */
struct ptable_type {
...
void setproctickets(struct proc* p, int n);
/* end of added code */
#endif // _PROC_H_
